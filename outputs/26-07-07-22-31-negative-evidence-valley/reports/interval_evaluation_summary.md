...
| Low-FP with valley cut | 775204 | 0.489 | 0.705 | 0.443 | 0.696 | 0.552 | 0.551 | 0.104 | 347264 | 0.448 |
...
The valley method applies normal-anchor post-processing to the selected Low-FP predictions. It detects low, stable score intervals and cuts PI only when the anchor does not overlap protected s-GT/uc-GT.
...
- Target eval recall: 0.681.
- FP Removed by NI: 3300 frames.
- TP Lost by NI: 0 frames.
- NI-over-sGT Ratio: 0.071.
- NI-over-ucGT Ratio: 0.016.
